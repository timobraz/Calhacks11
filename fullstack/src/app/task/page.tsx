...
function Task() {
  ...
  return (
    <div className="flex h-screen bg-black text-white lg:flex-row flex-col w-full">
      {/* Left side - Chat */}
      <div className="w-full flex-1 flex flex-col p-4 border-r border-gray-700  h-1/2 lg:h-full">
        <div className="mb-4 flex justify-between items-center">
          <div className="flex items-center">
            <button onClick={() =>{handleDeleteTask(); router.push('/start');}} className="mr-4 text-gray-400 hover:text-white">
